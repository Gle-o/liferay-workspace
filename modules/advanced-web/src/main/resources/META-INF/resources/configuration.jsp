...
<aui:form cssClass="container-fluid-1280" action="${configurationActionURL}" method="post" name="fm">
	...
	<aui:fieldset markupView="lexicon">
		...
		<aui:input name="preferences--planet--" type="text" value="${advancedSystemPortletInstanceConfiguration.planet()}" >
			<aui:validator name="required"/>
		</aui:input>
	</aui:fieldset>
	<aui:button-row>
