...
@Component(
	immediate = true,
	property = "path=/login/login",
	service = StrutsPortletAction.class
)
public class AdvancedWebPortletAction extends BaseStrutsPortletAction {
	...
	public void processAction(
		...
		_log.info("AdvancedWebPortletAction - processAction");
	...
	public void serveResource(
		...
		_log.info("AdvancedWebPortletAction - serveResource");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AdvancedWebPortletAction.class);
