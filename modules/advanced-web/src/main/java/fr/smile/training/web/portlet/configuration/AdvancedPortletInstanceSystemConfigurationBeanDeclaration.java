 ...
 */
@Component
public class AdvancedPortletInstanceSystemConfigurationBeanDeclaration implements ConfigurationBeanDeclaration {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return AdvancedPortletInstanceSystemConfiguration.class;
	}
