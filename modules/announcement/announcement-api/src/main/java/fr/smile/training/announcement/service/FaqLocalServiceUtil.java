...
package fr.smile.training.announcement.service;
 ...
 * <code>fr.smile.training.announcement.service.impl.FaqLocalServiceImpl</code> and
...
public class FaqLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>fr.smile.training.announcement.service.impl.FaqLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static fr.smile.training.announcement.model.Faq addFaq(
		fr.smile.training.announcement.model.Faq faq) {
	 ...
	 * @return the new faq
	 */
	public static fr.smile.training.announcement.model.Faq createFaq(
		long faqId) {
	 ...
	 */
	public static fr.smile.training.announcement.model.Faq deleteFaq(
		fr.smile.training.announcement.model.Faq faq) {
	 ...
	 */
	public static fr.smile.training.announcement.model.Faq deleteFaq(long faqId)
	...
	public static fr.smile.training.announcement.model.Faq fetchFaq(
		long faqId) {
	 ...
	 */
	public static fr.smile.training.announcement.model.Faq
		fetchFaqByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 * @throws PortalException if a faq with the primary key could not be found
	 */
	public static fr.smile.training.announcement.model.Faq getFaq(long faqId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static fr.smile.training.announcement.model.Faq
			getFaqByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<fr.smile.training.announcement.model.Faq>
		getFaqs(int start, int end) {
	...
	public static java.util.List<fr.smile.training.announcement.model.Faq>
		getFaqsByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<fr.smile.training.announcement.model.Faq> orderByComparator) {
	 ...
	 */
	public static fr.smile.training.announcement.model.Faq updateFaq(
		fr.smile.training.announcement.model.Faq faq) {
