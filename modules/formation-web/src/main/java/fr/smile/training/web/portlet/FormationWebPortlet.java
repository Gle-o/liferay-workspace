...
import fr.smile.training.web.constants.FormationWebPortletKeys;
...
@Component(
	...
	property = {
		...
		"com.liferay.portlet.css-class-wrapper=formation-web",
		"javax.portlet.display-name=FormationWeb",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.init-param.edit-template=/edit.jsp",
		"javax.portlet.portlet-mode=text/html;view,edit",
		"javax.portlet.name=" + FormationWebPortletKeys.FORMATIONWEB,
...
public class FormationWebPortlet extends MVCPortlet {
	...
	*/
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		String editValue = portletPreferences.getValue(EDIT_VALUE, "");
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		// String editValue =
		// GetterUtil.getString(actionRequest.getParameter("editValue"));
